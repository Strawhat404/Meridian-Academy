...
| Role | Access |
|------|--------|
| Student | Profile, own submissions, own orders, own reviews, after-sales |
| Instructor | + Create/manage submissions, view student submissions |
| Academic Staff | + Content approval workflow, sensitive-word review queue |
| Administrator | Full access, user management, RBAC config, audit logs, payments |
